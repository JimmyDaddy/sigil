...
use sigil_kernel::{
    ...
    AgentRunInput, AgentThreadId, AgentThreadResult, AgentThreadResultRecordedEntry,
    AgentThreadStartedEntry, AgentThreadStatus, AgentThreadStatusChangedEntry,
    AgentThreadTerminalStatus, AgentUsageSummary, ApprovalHandler, ControlEntry, EventHandler,
    JsonlSessionStore, Provider, ProviderCapabilities, RunEvent, Session, SessionRef, SessionStats,
    TaskChildSessionEntry, TaskChildSessionRunOutput, TaskChildSessionRunRequest,
    TaskChildSessionRunner, TaskChildSessionStatus, TaskId, TaskRouteId, TaskRouteStatus,
    TaskStepSpec, TaskSubagentApprovalRouteEntry, ToolApproval, ToolCall, ToolErrorKind,
    ToolRegistryScope, ToolSpec, WorkspaceRootSnapshot, child_session_ref,
};
        ...
        append_control(
            ...
            ControlEntry::AgentThreadResultRecorded(AgentThreadResultRecordedEntry {
                result: AgentThreadResult {
                    ...
                    summary: final_text.trim().to_owned(),
                    artifacts: Vec::new(),
