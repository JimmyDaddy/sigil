...
pub const APPLICATION_COMMANDS: &[ApplicationCommandSpec] = &[
    ApplicationCommandSpec {
        ...
        description: "generate, validate, and activate a recoverable context checkpoint",
        argument_hint: None,
    ...
    ApplicationCommandSpec {
        ...
        aliases: &["/m"],
        label: "Change model",
        description: "set an exact model ID for the next run in this conversation",
        argument_hint: Some("<model-id|connection-id/model-id>"),
        completes_with_space: true,
    ...
    ApplicationCommandSpec {
        ...
        aliases: &[],
        label: "Update Sigil",
        description: "check for or install an admitted Sigil update",
        argument_hint: Some("[check|refresh|apply] [current|stable|beta]"),
        completes_with_space: true,
        client_action: None,
    },
    ApplicationCommandSpec {
