...
use sigil_mcp::{
    ...
    McpOAuthCredentialRecord, McpOAuthCredentialScope, McpOAuthCredentialStore,
    McpOAuthHttpPurpose, McpOAuthHttpRequest, McpOAuthHttpResponse, McpOAuthTransportError,
};
