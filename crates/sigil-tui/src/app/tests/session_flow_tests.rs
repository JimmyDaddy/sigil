        ...
        entries: vec![
            ...
            SessionLogEntry::Control(ControlEntry::ToolEgress(Box::new(ToolEgressEntry {
                ...
                subjects: vec![ToolSubjectAudit {
                    ...
                    relative_label: Some("mcp__fake__echo".to_owned()),
        ...
        SessionLogEntry::Control(ControlEntry::ToolApproval(
            sigil_kernel::ToolApprovalEntry {
                ...
                identity: sigil_kernel::ApprovalRequestIdentityV2 {
                    session_id: "session-write-1".to_owned(),
                    run_id: "run-write-1".to_owned(),
                    call_id: "call-write-1".to_owned(),
                    approval_request_id: "approval-call-write-1".to_owned(),
                    plan_hash: "sha256:write-plan".to_owned(),
                    policy_version: "sha256:write-policy".to_owned(),
                    execution_binding_hash: "sha256:write-binding".to_owned(),
                    expires_at_ms: 1_000,
                },
                plan_hash: "sha256:write-plan".to_owned(),
