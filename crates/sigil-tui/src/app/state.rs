...
pub(crate) struct ComposerState {
    ...
    pub(crate) pending_user_input_queue: Vec<PendingUserInputForm>,
    pub(crate) pending_user_input_queue_index: usize,
...
impl Default for ComposerState {
    fn default() -> Self {
        Self {
            ...
            pending_user_input_queue: Vec::new(),
            pending_user_input_queue_index: 0,
