...
pub use dto::{
    ...
    DesktopApplicationExtensionCatalog, DesktopApplicationModelOption,
    ...
    DesktopPendingApproval, DesktopPermissionMode, DesktopReasoningEffort,
    ...
    DesktopSessionCreateRequest, DesktopSessionDeleteRequest, DesktopSessionListResponse,
