...
pub use dto::{
    DesktopApplicationAgentBinding, DesktopApplicationAgentCatalogEntry,
    DesktopApplicationClientAction, DesktopApplicationCommandCatalogEntry,
    DesktopApplicationExtensionCatalog, DesktopApplicationSkillBinding,
    ...
    DesktopCatalogQuery, DesktopCommandEnvelope, DesktopContextWindowSource,
    ...
    DesktopRunStartRequest, DesktopRunStatus, DesktopSessionCatalogEntry,
    DesktopSessionCatalogPage, DesktopSessionCatalogState, DesktopSessionCreateRequest,
    DesktopSessionDeleteRequest, DesktopSessionListResponse, DesktopSessionMutationReceipt,
    DesktopSessionOpenRequest, DesktopSessionQuarantineReceipt, DesktopSessionQuarantineRequest,
    DesktopSessionRenameRequest, DesktopSessionSnapshot, DesktopSessionTranscriptMessage,
    DesktopSessionTranscriptPage, DesktopTranscriptAssistantKind, DesktopTranscriptQuery,
