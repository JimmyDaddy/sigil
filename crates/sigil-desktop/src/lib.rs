...
pub use dto::{
    ...
    DesktopIntegrationPromotionTargetKind, DesktopIntent, DesktopIntentAcceptanceCriterion,
    DesktopIntentApplicationState, DesktopIntentArtifactAvailability, DesktopIntentArtifactKind,
    DesktopIntentArtifactOwnership, DesktopIntentArtifactSummary, DesktopIntentAuthorityState,
    DesktopIntentConflict, DesktopIntentDefinitionState, DesktopIntentDropCommandReceipt,
    DesktopIntentDropPreviewRequest, DesktopIntentDropRequest, DesktopIntentOperationErrorCode,
    DesktopIntentOperationExecution, DesktopIntentOperationFileAction,
    ...
    DesktopPendingApproval, DesktopPermissionMode, DesktopProviderConfigMode,
    DesktopProviderConnectionEntry, DesktopProviderConnectionInventory,
    ...
    DesktopProviderLegacyMigrationWarning, DesktopProviderModelRef, DesktopProviderSetupCatalog,
    ...
    DesktopSupportBundleExport, DesktopSupportCheck, DesktopSupportDoctorReport,
    ...
    DesktopTaskPauseCommandReceipt, DesktopTaskPauseRequest, DesktopToolArtifactAvailability,
    DesktopToolArtifactPage, DesktopToolArtifactPageEncoding, DesktopToolArtifactReadRequest,
    DesktopToolArtifactSelector, DesktopToolOutputShrinkReceipt, DesktopTranscriptAssistantKind,
    DesktopTranscriptQuery, DesktopTranscriptRole, DesktopVerificationAction,
    DesktopVerificationCheckStatus, DesktopVerificationEvidence,
