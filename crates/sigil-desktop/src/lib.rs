...
pub use dto::{
    ...
    DesktopPermissionMode, DesktopProviderConfigMode, DesktopProviderConnectionEntry,
    ...
    DesktopProviderLegacyMigrationOutcome, DesktopProviderLegacyMigrationPreview,
    DesktopProviderLegacyMigrationResult, DesktopProviderLegacyMigrationWarning,
