...
pub use dto::{
    ...
    DesktopApplicationAgentCatalogEntry, DesktopApplicationCacheUsage,
    ...
    DesktopApprovalDecisionRequest, DesktopApprovalLifecycleState, DesktopApprovalLifecycleView,
    DesktopApprovalRecordedDecision, DesktopApprovalRouteState, DesktopCatalogQuery,
    DesktopCheckpointFileAvailability, DesktopCheckpointFileView,
    ...
    DesktopPlanAction, DesktopPlanAgentRole, DesktopPlanCheckCommand, DesktopPlanCheckEffect,
    DesktopPlanDecisionAction, DesktopPlanDecisionCommandReceipt, DesktopPlanDecisionRequest,
    DesktopPlanIsolationMode, DesktopPlanLineage, DesktopPlanReview, DesktopPlanReviewDetail,
...
pub use events::{
    ...
    DesktopPublicAssistantMessage, DesktopPublicControlEvent, DesktopPublicConversationRoute,
    DesktopPublicRunEvent, DesktopPublicRunEventKind, DesktopPublicSessionRouteTransitionView,
    DesktopPublicTaskPhase, DesktopPublicTaskPlanStep, DesktopPublicToolCall,
    ...
    DesktopTimelineRouteRecovery, DesktopTimelineRouteTransition, DesktopTimelineTask,
    DesktopTimelineTaskPlanStep, DesktopTimelineTerminalTask, DesktopTimelineToolExecution,
};
pub use launcher::{
