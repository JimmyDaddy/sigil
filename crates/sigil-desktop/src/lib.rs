...
pub use dto::{
    ...
    DesktopTaskContinuationRequest, DesktopTaskIntegrationAcceptanceCommandReceipt,
    DesktopTaskIntegrationAcceptanceView, DesktopTaskIntegrationLaneView,
    DesktopTaskIntegrationReviewRequest, DesktopTaskIntegrationReviewView,
    DesktopTaskPauseCommandReceipt, DesktopTaskPauseRequest, DesktopTerminalExecutionBackendKind,
    DesktopTerminalLifecycleView, DesktopTerminalReadinessKind, DesktopTerminalReadinessStatus,
