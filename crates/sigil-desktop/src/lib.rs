...
pub use dto::{
    ...
    DesktopConversationTerminalFrontier, DesktopCutoverAuthority, DesktopCutoverBlocker,
    DesktopCutoverBlockerCode, DesktopCutoverEpoch, DesktopCutoverStatus,
    DesktopDurableSessionFrontier, DesktopExecutionSandboxProfile, DesktopForegroundRunOwner,
    ...
    DesktopPlanReviewDetail, DesktopPlanReviewSource, DesktopPlanReviewStatus,
    DesktopPlanReviewStepDetail, DesktopPlanRevisionStatus, DesktopPlanRevisionSummary,
    DesktopPlanSourceRef, DesktopPlanSourceTurn, DesktopPlanStepMode, DesktopPlanSuggestedCheck,
