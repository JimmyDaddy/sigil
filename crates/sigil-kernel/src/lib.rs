...
pub use permission::{
    ...
    PermissionMode, PermissionPolicy, PermissionPolicyChain, PermissionRisk, PermissionRule,
    ToolApprovalSessionGrantAvailability, ToolApprovalSessionGrantFacet,
    ToolApprovalSessionGrantScope, ToolApprovalSessionGrantUnavailableReason,
    ToolApprovalSessionGrantUnavailableReasonCode, ToolOperation, apply_risk_overlay,
    classify_path_trust_zone, derive_permission_risk, derive_permission_risk_with_network_effect,
    evaluate_network_policy, infer_tool_operation,
...
pub use session::{
    ...
    TOOL_PERMISSION_PLANNED_AUDIT_SCHEMA_VERSION, TailTurnStateV3, TaskMemoryInvalidatedEntry,
    TaskMemoryInvalidationReason, TaskMemoryRecordedV1, TaskMemorySnapshotRelation,
    ToolApprovalAllowSource, ToolApprovalAuditAction, ToolApprovalDecisionReceiptV2,
    ToolApprovalEntry, ToolApprovalSessionGrantEntry, ToolApprovalSessionGrantExpiry,
    ToolApprovalTerminalStatusV2, ToolApprovalUserDecision, ToolArtifactAvailability,
    ToolArtifactBindingV1, ToolArtifactBudgetedReadV1, ToolArtifactCompleteness,
    ToolArtifactDescriptorV1, ToolArtifactEncoding, ToolArtifactGcReportV1, ToolArtifactGcRootsV1,
    ...
    ToolDisplayCapability, ToolDisplayViewV1, ToolEgressEntry, ToolExecutionEntry,
    ToolExecutionStatus, ToolModelViewV1, ToolOutputAgedViewV1, ToolOutputAgingActivatedV1,
    ToolOutputAgingBatchV1, ToolOutputAgingProjectionV1, ToolOutputAgingReasonV1,
    ToolOutputArchivedArtifactBindingV1, ToolOutputArtifactRefV1,
    ...
    ToolOutputProjectionSourceRef, ToolOutputRetentionClassV1, ToolOutputShrinkReasonV1,
    ToolPermissionDecisionV2Entry, ToolPermissionPlannedV2Entry, ToolPreviewKind,
    ToolResultCapturePathV1, ToolResultCaptureTelemetryV1, ToolResultFactsV1, ToolResultRecordedV2,
    ToolSubjectAudit, TypedDomainEventRecord, UntrustedModelNarrativeV2, V2CompactionPreview,
...
pub use task::{
    ...
    TaskGraphStepProjection, TaskGuidanceAppliedEntry, TaskGuidanceApplyReason,
    ...
    TaskStateProjection, TaskStepAttemptId, TaskStepEntry, TaskStepId, TaskStepMode,
    TaskStepProjection, TaskStepSpec, TaskStepStatus, TaskSubagentApprovalRouteEntry,
    TaskSubagentElicitationRouteEntry, bounded_task_participant_summary, child_session_ref,
