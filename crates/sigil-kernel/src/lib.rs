...
pub use session::{
    ...
    ToolArtifactCompleteness, ToolArtifactDescriptorV1, ToolArtifactEncoding,
    ToolArtifactGcReportV1, ToolArtifactGcRootsV1, ToolArtifactManifestEntryV1,
    ToolArtifactPageEncoding, ToolArtifactPageV1, ToolArtifactReadBudgetV1,
    ToolArtifactReadOutcome, ToolArtifactReadRecordedV1, ToolArtifactRefV1,
    ToolArtifactRetentionClass, ToolArtifactRetrievalPolicyV1, ToolArtifactSelectorV1,
    ToolArtifactSensitivity, ToolArtifactStore, ToolArtifactTrashPruneReportV1,
    ToolArtifactTruncationV1, ToolArtifactUnavailableV1, ToolDisplayCapability, ToolDisplayViewV1,
    ToolEgressEntry, ToolExecutionEntry, ToolExecutionStatus, ToolModelViewV1,
    ...
    ToolOutputContextEpochTransitionV1, ToolOutputPressureItemV1, ToolOutputPressureProjectionV1,
    ToolOutputPressureSnapshotV1, ToolOutputProjection, ToolOutputProjectionPolicy,
    ToolOutputProjectionShrink, ToolOutputProjectionShrinkRecorded,
    ToolOutputProjectionSidecarProjection, ToolOutputProjectionSourceRef,
    ToolOutputRetentionClassV1, ToolOutputShrinkReasonV1, ToolPreviewKind, ToolResultCapturePathV1,
    ToolResultCaptureTelemetryV1, ToolResultFactsV1, ToolResultRecordedV2, ToolSubjectAudit,
