...
pub use session::{
    ...
    ToolDisplayCapability, ToolDisplayViewV1, ToolEgressEntry, ToolErrorSummaryV1,
    ToolExecutionCapturePlanV1, ToolExecutionEntry, ToolExecutionStatus, ToolModelViewV1,
