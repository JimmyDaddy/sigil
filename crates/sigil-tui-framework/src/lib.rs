...
pub use sigil_tui_core::{
    ...
    MAX_SURFACE_NODES, MAX_SURFACE_TEXT_BYTES, NodeId, NodeKey, PresentFault, PresentNotStarted,
    PresentOutcome, ProjectionPageRequest, Rect, ScrollAnchor, Surface, SurfaceItemId, SurfaceNode,
    SurfaceNodeKind, TerminalCapabilities, TrustedPresentReceipt, ViewportAnchor, VirtualSequence,
};
