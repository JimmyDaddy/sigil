...
**Version boundary:** this page and the GitHub Pages site track `main`. The packaged alpha is `v0.0.1-alpha.3` and can lag behind the capabilities below; check [Unreleased](changelog.md#unreleased-main) before relying on a newer feature.
