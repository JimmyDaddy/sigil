...
Self-update, a stable plugin API, signed or notarized desktop installers, a desktop update channel, uniform sandbox guarantees across platforms, and resuming an in-flight child process after the desktop app or its workspace service restarts are not promised today.
