...
crash-gap reconciliation、O5a read concurrency、O5b2a whole-batch admission 和 O5b2b
supervisor-lifetime provider route cooldown 已完成；durable bounded retry、adaptive route 并发窗口与
completion-arrival 进度仍属于 O5b2。`TaskRunProjection.active_steps` 和 TUI 多 active-step
