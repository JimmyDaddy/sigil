...
crash-gap reconciliation 和 O5a read concurrency 已完成；provider cooldown/backpressure 与完整
active-step 产品投影仍属于 O5b。目标协议和分阶段改进计划见
