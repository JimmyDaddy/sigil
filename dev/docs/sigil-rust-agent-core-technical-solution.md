...
和 O5b2d1 adaptive provider route concurrency window 已完成；Planner/Synthesis retry、
实时 route attribution 与 completion-arrival 进度仍属于 O5b2。
