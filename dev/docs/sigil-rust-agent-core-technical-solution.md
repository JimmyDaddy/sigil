...
supervisor-lifetime provider route cooldown 和 O5b2c shared-read-only durable bounded retry
已完成；Planner/Synthesis retry、adaptive route 并发窗口与 completion-arrival 进度仍属于
O5b2。`TaskRunProjection.active_steps` 和 TUI 多 active-step
