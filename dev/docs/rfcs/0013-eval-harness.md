...
- 2026-07-15: RFC-0028 completed E13.11 with five committed generated fixtures, an explicit bounded production-path runner, real verification receipts and stale evidence, schema V3 reports, exact trend buckets, a hidden process adapter, and binary loopback acceptance. Real-provider execution remains optional release-prep evidence rather than a normal CI gate.
