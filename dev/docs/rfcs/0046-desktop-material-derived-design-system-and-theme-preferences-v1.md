...
状态：active / R46.0-R46.2、R46.4-R46.6 complete，R46.3 implementation complete / native gate pending，R46.7 ready
...
## 20. R46.3 implementation status
...
本机 native test 尚不能记为 pass：`cargo test -p sigil-desktop-app appearance` 在执行新链接的 Tauri build-script 前卡在
