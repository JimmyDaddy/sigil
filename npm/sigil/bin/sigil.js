...
const packageByPlatform = {
  "darwin-arm64": "@sigil-ai/sigil-darwin-arm64",
  "darwin-x64": "@sigil-ai/sigil-darwin-x64",
  "linux-arm64": "@sigil-ai/sigil-linux-arm64",
  "linux-x64": "@sigil-ai/sigil-linux-x64",
  "win32-arm64": "@sigil-ai/sigil-win32-arm64",
  "win32-x64": "@sigil-ai/sigil-win32-x64",
};
...
try {
  ...
  console.error(
    `Sigil binary package ${packageName} is not installed. Reinstall @sigil-ai/sigil for ${platformKey}.`,
  );
  process.exit(1);
}
