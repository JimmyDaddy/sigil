...
const attachment: RunAttachment = {
  ...
  events: [
    ...
    },
    {
      ...
      status: "running",
      task: {
        taskId: "catalog-task-parser",
        objective: "Repair parser recovery and verify the exact change",
      },
    },
    {
      workspaceId: workspace.id,
    ...
    },
    {
      ...
      task: {
        ...
        steps: [
          {
            stepId: "inspect-parser",
            title: "Inspect recovery path",
            role: "explorer",
            dependsOn: [],
            mode: "read_only",
            isolation: "shared",
          ...
          {
            stepId: "repair-parser",
            title: "Repair bounded parser behavior",
            role: "implementer",
            dependsOn: ["inspect-parser"],
            mode: "write",
            isolation: "worktree",
          },
        ],
    ...
    },
    {
      ...
      runSequence: "15",
      replayable: true,
      kind: "task_batch_changed",
      status: "running",
      task: {
        taskId: "catalog-task-parser",
        planVersion: 2,
        batchId: "catalog-batch-2",
        active: 1,
        completed: 1,
        failed: 0,
      },
...
export function createCatalogWorkbenchBridge(
  ...
  return {
    ...
    continueTask: async (_workspaceId, sessionId, _taskId, permissionMode) => ({
      id: "catalog-run-task-continue",
      sessionId,
      status: "running",
      permissionMode,
      streamSequence: 0,
