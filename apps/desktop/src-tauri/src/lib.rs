...
use crate::{
    ...
    commands::{
        ...
        desktop_catalog, desktop_checkpoint_restore_preview, desktop_close_workspace,
        ...
        desktop_plan_session_catalog_batch, desktop_provider_connections,
        ...
        desktop_support_doctor, desktop_transcript, desktop_verification, resolve_sigil_binary,
    },
...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            desktop_migrate_legacy_provider_connections,
            desktop_recheck_legacy_provider_migration,
