...
use crate::{
    ...
    commands::{
        ...
        desktop_pick_workspace, desktop_plan_decision, desktop_plan_detail,
        desktop_plan_session_catalog_batch, desktop_preview_intent_drop,
        desktop_provider_connections, desktop_provider_setup_catalog, desktop_quarantine_session,
        desktop_read_tool_artifact, desktop_rename_session, desktop_rerun_verification,
        desktop_resolve_approval, desktop_run_context, desktop_save_provider_default_model,
        desktop_save_provider_setup, desktop_set_appearance, desktop_start_run,
        desktop_support_doctor, desktop_task_integration_review, desktop_transcript,
        desktop_user_input_decision, desktop_user_input_request, desktop_verification,
...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            desktop_plan_detail,
            desktop_user_input_request,
            desktop_user_input_decision,
