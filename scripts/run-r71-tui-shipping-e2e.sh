...
run current-schema-boot cargo test --locked -p sigil-tui --lib \
  r71_shipping_tui_current_schema_bootstrap_runs_real_authority_file_surface -- --format terse
run launcher-setup-and-replacement cargo test --locked -p sigil-tui --lib launcher::tests -- --format terse
