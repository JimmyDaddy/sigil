...
run current-schema-boot cargo test --locked -p sigil-tui-host --test r71_shipping_e2e \
  production_boot_current_schema_uses_real_authority_transaction -- --format terse
run launcher-production-replacement cargo test --locked -p sigil-tui-host --test r71_shipping_e2e \
