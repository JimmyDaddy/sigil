...
required_files=(
  ...
  "assets/screenshots/planned-task-execution.svg"
...
grep -q '<img src="../../assets/screenshots/planned-task-execution.svg"' "${stage_dir}/docs/visual-tour/index.html"
grep -q '<img src="../../../assets/screenshots/planned-task-execution.svg"' "${stage_dir}/zh-CN/docs/visual-tour/index.html"
...
grep -q 'Generated from Sigil TUI renderer' "${stage_dir}/assets/screenshots/planned-task-execution.svg"
