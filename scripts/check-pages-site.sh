...
required_files=(
  ...
  "assets/site.css"
  "assets/search.js"
  "assets/logo/sigil-full.png"
  "assets/logo/sigil-full-flat.svg"
  "assets/logo/sigil-full-flat-2x.png"
  "assets/logo/sigil-mark-transparent.png"
  "assets/logo/sigil-mark-square-1024.png"
  "assets/logo/sigil-wordmark-header.png"
  "assets/logo/sigil-wordmark-header.svg"
  "assets/logo/sigil-wordmark-header-2x.png"
  "assets/logo/sigil-wordmark-transparent.png"
  "assets/logo/sigil-wordmark-transparent.svg"
  "assets/logo/sigil-wordmark-transparent-2x.png"
...
grep -q 'class="brand-wordmark" src="assets/logo/sigil-wordmark-header.svg"' "${stage_dir}/index.html"
grep -q 'class="brand-wordmark" src="../assets/logo/sigil-wordmark-header.svg"' "${stage_dir}/docs/index.html"
grep -q 'class="brand-wordmark" src="../../assets/logo/sigil-wordmark-header.svg"' "${stage_dir}/zh-CN/docs/index.html"
grep -q 'class="brand-wordmark" src="../../assets/logo/sigil-wordmark-header.svg"' "${stage_dir}/docs/quickstart/index.html"
grep -q 'class="brand-mark" src="assets/logo/sigil-mark-transparent.png"' "${stage_dir}/index.html"
grep -q 'class="brand-mark" src="../assets/logo/sigil-mark-transparent.png"' "${stage_dir}/docs/index.html"
grep -q 'class="brand-mark" src="../../assets/logo/sigil-mark-transparent.png"' "${stage_dir}/zh-CN/docs/index.html"
grep -q 'class="brand-mark" src="../../assets/logo/sigil-mark-transparent.png"' "${stage_dir}/docs/quickstart/index.html"
