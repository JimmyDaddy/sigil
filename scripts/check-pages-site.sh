...
grep -q 'class="brand-wordmark" src="assets/logo/sigil-full-staff-glow.svg"' "${stage_dir}/index.html"
grep -q 'class="brand-wordmark" src="../assets/logo/sigil-full-staff-glow.svg"' "${stage_dir}/docs/index.html"
grep -q 'class="brand-wordmark" src="../../assets/logo/sigil-full-staff-glow.svg"' "${stage_dir}/zh-CN/docs/index.html"
grep -q 'class="brand-wordmark" src="../../assets/logo/sigil-full-staff-glow.svg"' "${stage_dir}/docs/quickstart/index.html"
