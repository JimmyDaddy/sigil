...
post_json() {
  ...
  local -a request_args=(
    ...
    -H 'User-Agent: Sigil/0.0.1-alpha.1 (release-evidence)'
  )
...
post_json \
  '{"jsonrpc":"2.0","id":"sigil-probe-initialize","method":"initialize","params":{"protocolVersion":"2025-06-18","capabilities":{},"clientInfo":{"name":"Sigil","version":"0.0.1-alpha.1"}}}' \
