...
PRODUCER_RULES = [
    ...
    ("sigil-resource-authority/src/allocator", "managed-runtime-state", "AuthorityBootstrap",
     "AuthorityBootstrapAnchor", "None", "None", "AuthorityBootstrapAdmission",
     "AuthorityBootstrapObject(ExecutionTempAnchor)", "AuthorityBootstrapLifecycle",
