...
cp assets/demo/sigil-desktop-demo.{mp4,webm} "${out_dir}/assets/demo/"
cp assets/demo/sigil-desktop-demo-poster.png "${out_dir}/assets/demo/"
cp assets/demo/sigil-desktop-demo.{en,zh-CN}.vtt "${out_dir}/assets/demo/"
