...
LOCALES = {
  "en" => {
    ...
    version_notice_text: "These pages track main. The packaged alpha remains v0.0.1-alpha.2; newer features may require a source install.",
  ...
  "zh-CN" => {
    ...
    version_notice_text: "这些页面跟随 main。已打包发布的 alpha 仍是 v0.0.1-alpha.2；较新的能力可能需要从源码安装。",
